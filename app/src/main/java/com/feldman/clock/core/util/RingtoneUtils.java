...
import com.feldman.clock.core.data.CustomRingtone;
import com.feldman.clock.core.data.RingtoneModel;
...
public class RingtoneUtils {
    ...
    public static Uri getRandomCustomRingtoneUri() {
        ...
        SharedPreferences prefs = ClockApplication.getDefaultSharedPreferences(context);
