...
public final class Events {
     ...
     */
    public static final String EXTRA_EVENT_LABEL = "com.feldman.clock.extra.EVENT_LABEL";
    ...
    /**
     * Tracks a standby event.
     *
     * @param action resource id of event action
     * @param label  resource id of event label
     */
    public static void sendStandbyEvent(@StringRes int action, @StringRes int label) {
        sendEvent(R.string.category_standby, action, label);
    }
