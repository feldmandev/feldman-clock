...
public class PreferencesDefaultValues {
    public static final boolean DEFAULT_AUTO_OPEN_FIRING_SCREEN = true;
    ...
    public static final boolean DEFAULT_SHOW_UPCOMING_ALARM_NOTIFICATION = true;
    public static final boolean DEFAULT_SHOW_MISSED_ALARM_NOTIFICATION = true;
    ...
    // Standby
    public static final boolean DEFAULT_DISPLAY_STANDBY_CLOCK_SECONDS = false;
    public static final int DEFAULT_STANDBY_CUSTOM_COLOR = Color.WHITE;
    public static final int DEFAULT_STANDBY_HOUR_COLOR = Color.rgb(184, 196, 255);
    public static final int DEFAULT_STANDBY_MINUTE_COLOR = Color.WHITE;
    public static final boolean DEFAULT_STANDBY_SHOW_DATE = true;
    public static final String DEFAULT_STANDBY_DATE_FORMAT = "EEE, MMM d";
    public static final int DEFAULT_STANDBY_DATE_SIZE_PERCENT = 100;
    public static final int DEFAULT_STANDBY_DATE_SPACING_DP = 0;
    public static final boolean DEFAULT_STANDBY_SHOW_NEXT_ALARM = true;
    public static final int DEFAULT_STANDBY_BRIGHTNESS = 40;
    public static final boolean DEFAULT_STANDBY_DIGITAL_CLOCK_IN_BOLD = false;
    public static final boolean DEFAULT_STANDBY_DIGITAL_CLOCK_IN_ITALIC = false;
    public static final boolean DEFAULT_STANDBY_DATE_IN_BOLD = true;
    public static final boolean DEFAULT_STANDBY_DATE_IN_ITALIC = false;
    public static final boolean DEFAULT_STANDBY_NEXT_ALARM_IN_BOLD = true;
    public static final boolean DEFAULT_STANDBY_NEXT_ALARM_IN_ITALIC = false;
    public static final int DEFAULT_STANDBY_ROTATION_MODE = 0; // Auto
    public static final int DEFAULT_STANDBY_SCALE_PERCENT = 100;
    public static final int DEFAULT_STANDBY_CLOCK_WEIGHT_PERCENT = 100;
    public static final int DEFAULT_STANDBY_CLOCK_WIDTH_PERCENT = 100;
    public static final boolean DEFAULT_STANDBY_CLOCK_WIDTH_AUTO = true;
    public static final int DEFAULT_STANDBY_CLOCK_ROUNDNESS_PERCENT = 100;
    public static final int DEFAULT_STANDBY_TIME_SPACING_DP = 0;
    public static final int DEFAULT_STANDBY_FONT_WEIGHT = 400;
    public static final boolean DEFAULT_STANDBY_WIRELESS_ONLY = false;
    public static final Set<String> DEFAULT_STANDBY_WIDGET_IDS =
            Collections.emptySet();

    public static final int DEFAULT_STANDBY_MAX_SLANT = 45;     // degrees (0–90)
    public static final int DEFAULT_STANDBY_FONT_WIDTH = 100;   // percent (25–151)
    public static final boolean DEFAULT_STANDBY_VIBRANT_PALETTE = false;
    public static final boolean DEFAULT_STANDBY_DYNAMIC_COLOR = true;
    public static final boolean DEFAULT_STANDBY_SINGLE_COLOR_MODE = false;
    public static final int DEFAULT_STANDBY_PAGE_LAYOUT = 0; // PAGER
    public static final float DEFAULT_STANDBY_SPLIT_RATIO = 0.5f;
