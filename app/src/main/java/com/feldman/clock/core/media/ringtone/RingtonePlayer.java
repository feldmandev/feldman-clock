...
import static com.feldman.clock.settings.PreferencesKeys.KEY_AUTO_ROUTING_TO_BLUETOOTH_DEVICE;
...
public final class RingtonePlayer {
    ...
    public void play(Uri ringtoneUri, long crescendoDuration) {
        ...
        Log.d("RingtonePlayer", "RingtonePlayer - Playing ringtone URI: " + ringtoneUri);
        ...
        if (preferredDevice != null) {
            ...
            Log.v("RingtonePlayer", "Preferred audio device set at start: " + preferredDevice.getType());
        }
        ...
        mAudioDeviceCallback = new AudioDeviceCallback() {
            ...
            public void onAudioDevicesAdded(AudioDeviceInfo[] addedDevices) {
                for (AudioDeviceInfo device : addedDevices) {
                    if (RingtoneUtils.isBluetoothDevice(device)) {
                        Log.v("RingtonePlayer", "Bluetooth device connected: forcing playback to it");
                        if (mExoPlayer != null) {
            ...
            public void onAudioDevicesRemoved(AudioDeviceInfo[] removedDevices) {
                for (AudioDeviceInfo device : removedDevices) {
                    if (RingtoneUtils.isBluetoothDevice(device)) {
                        Log.v("RingtonePlayer", "Bluetooth device disconnected: switching back to speaker");
                        if (mExoPlayer != null) {
