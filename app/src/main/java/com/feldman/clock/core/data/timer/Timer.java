...
import static com.feldman.clock.core.data.Timer.State.MISSED;
import static com.feldman.clock.core.data.Timer.State.PAUSED;
import static com.feldman.clock.core.data.Timer.State.RESET;
import static com.feldman.clock.core.data.Timer.State.RUNNING;
import static com.feldman.clock.settings.PreferencesDefaultValues.SORT_TIMER_BY_ASCENDING_DURATION;
import static com.feldman.clock.settings.PreferencesDefaultValues.SORT_TIMER_BY_DESCENDING_DURATION;
import static com.feldman.clock.settings.PreferencesDefaultValues.SORT_TIMER_BY_NAME;
import static com.feldman.clock.core.util.Utils.now;
import static com.feldman.clock.core.util.Utils.wallClock;
