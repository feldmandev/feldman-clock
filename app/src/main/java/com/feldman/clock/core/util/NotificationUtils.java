...
public class NotificationUtils {
     ...
     */
    public static final String FIRING_NOTIFICATION_CHANNEL_ID = "firingAlarmsAndTimersNotification_v3";
    /**
     * Channel ID for timer notifications.
     */
    public static final String TIMER_MODEL_NOTIFICATION_CHANNEL_ID = "timer_channel_high_priority";
    /**
    ...
    /** Removed with the bedtime feature; still deleted so it disappears from existing installs. */
    private static final String LEGACY_BEDTIME_NOTIFICATION_CHANNEL_ID = "bedtimeNotification";
    ...
    static {
        ...
        CHANNEL_PROPS.put(TIMER_MODEL_NOTIFICATION_CHANNEL_ID, new int[]{
                ...
                IMPORTANCE_HIGH // Changed to IMPORTANCE_HIGH
        });
    }
    ...
    public static void createChannel(Context context, String id) {
        ...
        if (id.equals(TIMER_MODEL_NOTIFICATION_CHANNEL_ID)) {
        ...
        if (id.equals(FIRING_NOTIFICATION_CHANNEL_ID)) {
             NotificationChannel channel = new NotificationChannel(
                     FIRING_NOTIFICATION_CHANNEL_ID,
                     context.getString(R.string.firing_alarms_timers_channel),
    ...
    public static void updateNotificationChannels(Context context) {
        ...
        deleteChannel(nm, "firingAlarmsAndTimersNotification");
        deleteChannel(nm, "firingAlarmsAndTimersNotification_v2");
        deleteChannel(nm, "alarmSnoozeNotification");
        deleteChannel(nm, LEGACY_BEDTIME_NOTIFICATION_CHANNEL_ID);
