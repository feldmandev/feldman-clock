...
public final class ClockContract {
     ...
     */
    interface AlarmSettingColumns extends BaseColumns {
     ...
     */
    interface AlarmsColumns extends AlarmSettingColumns, BaseColumns {
         ...
         * <p>Type: INTEGER</p>
         * <p>
         * {@link com.feldman.clock.core.data.Weekdays}
         */
        ...
        /**
         * Start time of the pause interval (milliseconds).
         * <p>Type: INTEGER (long)</p>
         */
        String PAUSE_START_TIME = "pause_start_time";

        /**
         * End time of the pause interval (milliseconds).
         * <p>Type: INTEGER (long)</p>
         */
        String PAUSE_END_TIME = "pause_end_time";
    }
