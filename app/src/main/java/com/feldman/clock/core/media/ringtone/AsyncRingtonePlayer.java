...
import static com.feldman.clock.core.util.RingtoneUtils.IN_CALL_VOLUME;
...
public final class AsyncRingtonePlayer {
    ...
    public void play(Uri ringtoneUri, long crescendoDuration) {
        Log.d("AsyncRingtonePlayer", "Executing play");
        mExecutor.execute(() -> {
     ...
     */
    public void stop() {
        Log.d("AsyncRingtonePlayer", "Executing stop");
        mExecutor.execute(() -> {
    ...
    public void shutdown() {
        if (mExecutor != null && !mExecutor.isShutdown()) {
            Log.d("AsyncRingtonePlayer", "Releasing AsyncRingtonePlayer resources");
            mExecutor.shutdown();
        } else {
            Log.d("AsyncRingtonePlayer", "No AsyncRingtonePlayer to release");
        }
    }
    ...
    private void scheduleVolumeAdjustment() {
        Log.v("AsyncRingtonePlayer", "Scheduling volume adjustment");
    ...
    private static class MediaPlayerPlaybackDelegate implements PlaybackDelegate {
        ...
        public boolean play(Context context, Uri ringtoneUri, long crescendoDuration) {
            ...
            Log.d("AsyncRingtonePlayer", "AsyncRingtonePlayer - Playing ringtone URI: " + ringtoneUri);
            ...
            if (mMediaPlayer == null) {
                Log.e("AsyncRingtonePlayer", "Unable to prepare MediaPlayer for ringtone.");
                return false;
            }
